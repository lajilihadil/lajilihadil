...
const onSubmitHandler= (e) => {
  ...
  useEffect(() => {
    ...
    setSpecialite('Masseur-kinésithérapeute');
  }, []);
          ...
          <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li className="nav-item dropdown" onMouseEnter={handleDropdownToggle} onMouseLeave={handleDropdownLeave}>
              ...
              Médecin généraliste
                ...
                <a className="dropdown-item" href="#" onClick={() => handleSpecialiteClick('Masseur-kinésithérapeute')}>
      ...
      <div className="row ">
        ...
        Masseur-kinésithérapeute
          ...
          <h1 className='title title--xxxlarge title--doodle2' style={{ fontSize: '25px' ,  color: '#7c9fc3' }}>
           Et si vous gagniez en confort de travail ?</h1>
        </div>
        <p className='title title--large'>
          "Optimisez toute votre activité, de la prise de RDV à la télétransmission, avec des solutions modulables et mobiles."
        </p>
        ...
        <li className='icon-text'>
          ...
          <p className='paragraoh icon-text__text paragraph--bold'>
           MédiSphèreVie kiné, la nouvelle solution de facturation
          </p>
        </li>
        ...
        <li className='icon-text'>
          <FontAwesomeIcon icon={faCheck} className='arrow-icon' />
          <p className='paragraoh icon-text__text paragraph--bold'>
           Une interface unique pour gérer tout votre cabinet
          </p>
        </li>
        ...
        <li className='icon-text'>
          <FontAwesomeIcon icon={faCheck} className='arrow-icon' />
          <p className='paragraoh icon-text__text paragraph--bold'>
          Sans engagement, 0 frais cachés
          </p>
        </li>
      </ul>
      </div>
        ...
        <div className="col-md-5 order-md-2 form-container">
          <form action="#" method="post" className='row pt-4' onSubmit={onSubmitHandler}>
            ...
            <input
              type="text"
              className={`form-control ${specialite === 'Masseur-kinésithérapeute' ? 'selected' : ''}`}
...
export default Masseurkinésithérapeute;
