    ...
    <div style={{
      ...
      > <FontAwesomeIcon icon={faStethoscope} style={{ marginRight: '10px' }}/>
        Médecins Généraliste
          ...
          <h1 className='title title--xxxlarge title--doodle2' style={{ fontSize: '25px' ,  color: '#7c9fc3' }}>Soyez le médecin que vous voulez etre , sans le stress administratif</h1>
        </div>
        <p className='title title--large' >
        "Nos solutions intégrées visent à simplifier votre quotidien, vous permettant ainsi de vous consacrer entièrement à vos patients."
      </p>
      
        <ul className='hero-form-yellow__list'>
        <li className='icon-text'>
          <FontAwesomeIcon icon={faCheck} className='arrow-icon' />
          <p className='paragraoh icon-text__text paragraph--bold' style={{   paddingTop: '20px',marginBottom: '30px' }}>
            Une suite logicielle adaptée à votre spécialité et mode d'exercice
          </p>
        </li>
        ...
        <li className='icon-text'>
          ...
          <p className='paragraoh icon-text__text paragraph--bold'>
            Accessible où que vous soyez, quand vous voulez
          </p>
        </li>
      </ul>
      </div>
        ...
        <div className="col-md-5 order-md-2 form-container">
          <form action="#" method="post" className='row pt-4' onSubmit={onSubmitHandler}>
            ...
            <input type="text" className='form-control' placeholder="Votre spécialité" name="specialité" id="specialité"  onChange={onChangeHandler}/>
