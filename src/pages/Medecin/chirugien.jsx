...
const onSubmitHandler= (e) => {
  ...
  useEffect(() => {
    ...
    setSpecialite('Chirurgien-dentiste');
  }, []);
          ...
          <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li className="nav-item dropdown" onMouseEnter={handleDropdownToggle} onMouseLeave={handleDropdownLeave}>
              ...
              Médecin généraliste
                ...
                <a className="dropdown-item" href="#" onClick={() => handleSpecialiteClick('Chirurgien-dentiste')}>
      ...
      ><FontAwesomeIcon icon={faTooth} style={{ marginRight: '10px' }}/>
        Chirugien-dentiste
          ...
          <h1 className='title title--xxxlarge title--doodle2' style={{ fontSize: '25px' ,  color: '#7c9fc3' }}>
            MédiSphèreVie vous aide à mieux gérer la relation avec notre patienltèle</h1>
        </div>
        <p className='title title--large'>
          "Gagnez en productivité et recentrez-vous sur le travail au fauteuil"
        </p>
        ...
        <li className='icon-text'>
          ...
          <p className='paragraoh icon-text__text paragraph--bold'>
           Qualification des patients à chaque étape de la prise de RDV
          </p>
        </li>
        ...
        <li className='icon-text'>
          <FontAwesomeIcon icon={faCheck} className='arrow-icon' />
          <p className='paragraoh icon-text__text paragraph--bold'>
           Communication à vos patients sur leur plan de traitement
          </p>
        </li>
      </ul>
      </div>
        ...
        <div className="col-md-5 order-md-2 form-container">
          <form action="#" method="post" className='row pt-4' onSubmit={onSubmitHandler}>
            ...
            <input
              type="text"
              className={`form-control ${specialite === 'Chirugien-dentiste' ? 'selected' : ''}`}
