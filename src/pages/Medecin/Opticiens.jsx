...
const onSubmitHandler= (e) => {
  ...
  useEffect(() => {
    ...
    setSpecialite('Opticiens/Audioprothésiste');
  }, []);
  ...
  return (
    <div style={{
          ...
          <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li className="nav-item dropdown" onMouseEnter={handleDropdownToggle} onMouseLeave={handleDropdownLeave}>
              ...
              Médecin généraliste
                ...
                <a className="dropdown-item" href="/Sagefemme" onClick={() => handleSpecialiteClick('Opticien-audioprothésistes')}>
      ...
      ><FontAwesomeIcon icon={faGlasses} style={{ marginRight: '10px' }}/>
        Opticiens-lunitiers & audioprothésistes
      </p>
          <h1 className='title title--xxxlarge title--doodle2' style={{ fontSize: '25px' ,  color: '#7c9fc3' }}>
            La solution utilisée par les Tuniisiens pour gérer leur santé  </h1>
        </div>
        <p className='title title--large'>
          "Améliorez l'accès aux soins ainsi que la santé visuelle et auditive des Tunisiens en augmentant votre visibilité auprès des patients et des professionnels de santé."
        </p>
        ...
        <li className='icon-text'>
          <FontAwesomeIcon icon={faCheck} className='arrow-icon' />
          <p className='paragraoh icon-text__text paragraph--bold'>
          Agenda paramétrable pour chaque organisation
          </p>
        </li>
        ...
        <div className="col-md-5 order-md-2 form-container">
          <form action="#" method="post" className='row pt-4' onSubmit={onSubmitHandler}>
            ...
            <input
              type="text"
              className={`form-control ${specialite === 'Opticien-audioprothésistes' ? 'selected' : ''}`}
