    ...
    <div style={{
      ...
      ><FontAwesomeIcon icon={faUserNurse} style={{ marginRight: '10px' }}/>
        ...
        <p className='title title--large'>
          "Optimisez votre activité en développant votre patieltèle et en centralisant tous vos échanges pour un meilleur suivi de vos patientes."
        </p>
        ...
        <li className='icon-text'>
          ...
          <p className='paragraoh icon-text__text paragraph--bold'>
           Installation en 2h, facile et personnalisée
          </p>
        </li>
        ...
        <li className='icon-text'>
          <FontAwesomeIcon icon={faCheck} className='arrow-icon' />
          <p className='paragraoh icon-text__text paragraph--bold'>
          Qualification des patientes à chaque étape de la prise de RDV
          </p>
        </li>
        ...
        <div className="col-md-5 order-md-2 form-container">
          <form action="#" method="post" className='row pt-4' onSubmit={onSubmitHandler}>
            ...
            <input
              type="text"
              className={`form-control ${specialite === 'Sage-Femme' ? 'selected' : ''}`}
