          ...
          <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li className="nav-item dropdown" onMouseEnter={handleDropdownToggle} onMouseLeave={handleDropdownLeave}>
              ...
              Médecin généraliste
                ...
                <a className="dropdown-item" href="#" onClick={() => handleSpecialiteClick('Infirmier')}>
                  <FontAwesomeIcon icon={faBrain} className="mr-2" />
                  Infirmier
                </a>
      ...
      ><FontAwesomeIcon icon={faBrain} style={{ marginRight: '10px' }}/>
        Infirmier(e)
          ...
          <h1 className='title title--xxxlarge title--doodle2' style={{ fontSize: '25px' ,  color: '#7c9fc3' }}>
            Allégez vos tournées et gagnez en confort de travail </h1>
        </div>
        <p className='title title--large'>
          "Avec MédiSphèreVie, développez votre activité en cabinet et simplifiez votre exercice coordonné."
        </p>
        ...
        <li className='icon-text'>
          ...
          Agenda et prise de RDV 100% adaptables à votre activité
          </p>
        </li>
        ...
        <li className='icon-text'>
          <FontAwesomeIcon icon={faCheck} className='arrow-icon' />
          <p className='paragraoh icon-text__text paragraph--bold'>
           Messagerie instantanée et annuaire de +400 000 professionels
          </p>
        </li>
        ...
        <div className="col-md-5 order-md-2 form-container">
          <form action="#" method="post" className='row pt-4' onSubmit={onSubmitHandler}>
            ...
            <input
              type="text"
              className={`form-control ${specialite === 'Infirmer' ? 'selected' : ''}`}
