...
const onSubmitHandler= (e) => {
  ...
  useEffect(() => {
    ...
    setSpecialite('Pédicure-Podologue');
  }, []);
  ...
  return (
    <div style={{
          ...
          <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li className="nav-item dropdown" onMouseEnter={handleDropdownToggle} onMouseLeave={handleDropdownLeave}>
              ...
              Médecin généraliste
                ...
                <a className="dropdown-item" href="#" onClick={() => handleSpecialiteClick('Pédicure-Podologue')}>
      ...
      ><FontAwesomeIcon icon={faBabyCarriage} style={{ marginRight: '10px' }}/>
        Pédicure-Podologue
      </p>
          <h1 className='title title--xxxlarge title--doodle2' style={{ fontSize: '25px' ,  color: '#7c9fc3' }}>
            La solution pour développer votre patientèle</h1>
        </div>
        <p className='title title--large'>
          "Augmentez les revenus de votre cabinet en étant visible sur la solution utilisée par 80 millions de patients en Tunisie."
        </p>
        ...
        <li className='icon-text'>
          ...
          Jusqu'à 5 nouveaux patients par mois
          </p>
        </li>
        ...
        <li className='icon-text'>
          <FontAwesomeIcon icon={faCheck} className='arrow-icon' />
          <p className='paragraoh icon-text__text paragraph--bold'>
           Agenda adaptable et accessible ou que vous soyez
          </p>
        </li>
        ...
        <div className="col-md-5 order-md-2 form-container">
          <form action="#" method="post" className='row pt-4' onSubmit={onSubmitHandler}>
            ...
            <input
              type="text"
              className={`form-control ${specialite === 'Pédicure-Podologue' ? 'selected' : ''}`}
...
export default PedicurePodologue;
